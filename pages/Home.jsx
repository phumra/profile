          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-100 font-normal leading-relaxed max-w-xl mx-auto md:mx-0 bg-black px-4 py-2 rounded-lg">
                ...
                high‑quality applications, improving system performance, and
                ensuring reliability through effective software testing.
              </p>
            ...
            <div className="flex justify-center order-1 md:order-2">
              <div
                data-aos="fade-left"
                data-aos-delay="200"
                className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl border border-white/10 shadow-xl shadow-indigo-500/5 overflow-hidden transition-all duration-500 group bg-slate-950"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-slate-950/70 backdrop-blur-md border-t border-white/10 z-20 flex flex-col items-center justify-center">
                  {/* <span className="text-base text-indigo-400 mb-1 drop-shadow-sm">
                    Email: phumrapee.sorn@gmail.com
                  </span> */}
                  <p className="text-base text-gray-200 font-medium">
                    Software Developer | Web, Mobile & Testing
                  </p>
                </div>
              </div>
            </div>
